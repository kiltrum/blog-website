...
<figure class="photo-grid-group">
    <div class="photo-grid photo-grid-2">
        <img src="/images/articles/wildspitze_vom_kaunertal/1.jpg" alt="Warten auf den Skibus">
        <img src="/images/articles/wildspitze_vom_kaunertal/2.jpg" alt="Blick ins Tal">
    </div>
    <figcaption>Warten auf den Skibus ins Kaunertal</figcaption>
    <figcaption>Blick Richtung Gepatschferner</figcaption>
</figure>
...
<figure class="photo-grid-group">
    <div class="photo-grid photo-grid-2">
        <img src="/images/articles/wildspitze_vom_kaunertal/3.jpg" alt="Skitourengeher in einer Gletscherhöhle">
        <img src="/images/articles/wildspitze_vom_kaunertal/4.jpg" alt="Skitourengeher am Weg zur Rauhekopfhütte">
    </div>
    <figcaption>Hier sind wir wenigstens windgeschützt</figcaption>
    <figcaption>Am Weg zur Rauhekopfhütte, im Hintergrund der Gletscherbruch, bei viel Schnee könnte man evtl. direkt über den Gletscher gehen</figcaption>
</figure>
...
<figure class="photo-grid-group">
    <div class="photo-grid photo-grid-2">
        <img src="/images/articles/wildspitze_vom_kaunertal/9.jpg" alt="Skistock mit provisorischem Teller">
        <img src="/images/articles/wildspitze_vom_kaunertal/10.jpg" alt="Skistock mit provisorischem Teller und Schlauchklemme">
    </div>
    <figcaption>Lucas professionelle Skistockreparaturen</figcaption>
</figure>

<figure class="article-photo article-photo-wide">
    <img src="/images/articles/wildspitze_vom_kaunertal/7.jpg" alt="Ausblick auf Gletscher vom Brandenburgerhaus">
    <figcaption>Ausblick nicht nur auf den Gletscher</figcaption>
</figure>
...
<figure class="photo-grid-group">
    <div class="photo-grid photo-grid-2">
        <img src="/images/articles/wildspitze_vom_kaunertal/11.jpg" alt="Skitourengeher beim Aufstieg zum Fluchtkogel">
        <img src="/images/articles/wildspitze_vom_kaunertal/12.jpg" alt="Telemarkfahrer in der Abfahrt">
    </div>
    <figcaption>Aufstieg zum Fluchtkogel</figcaption>
    <figcaption>Maxi mit seinen Telemarkski</figcaption>
</figure>
...
<figure class="article-photo">
    <img src="/images/articles/wildspitze_vom_kaunertal/13.jpg" alt="Gruppenfoto von Skitourengehern auf der Wildspitze">
    <figcaption>Fast alleine am Dach Tirols</figcaption>
</figure>
