...
function renderElevationProfile(container, data, map) {
    ...
    container.innerHTML = ''
        ...
        + '<text class="elevation-profile__label" x="' + padding.left + '" y="' + (height - 4) + '">0 km</text>'
        + '<text class="elevation-profile__label elevation-profile__label--end" x="' + (width - padding.right) + '" y="' + (height - 4) + '">' + maximumDistance.toFixed(1) + ' km</text>'
